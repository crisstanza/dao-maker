...
public final class DAOMaker {
	...
	public final void goGenericDAO() throws Exception {
		...
		bw.write("	}"+ _N);
		bw.write(_N);
		bw.write("	public static final close(final ResultSet rs, final Statement s, final Connection con) {"+ _N);
		bw.write("		DAO.close(rs);"+ _N);
		bw.write("		DAO.close(s);"+ _N);
		bw.write("		DAO.close(con);"+ _N);
		bw.write("	}"+ _N);
		bw.write(_N);
		bw.write("	private static final close(final ResultSet rs) {"+ _N);
		bw.write("		try {"+ _N);
		...
		bw.write("	}"+ _N);
		bw.write(_N);
		bw.write("	private static final close(final Statement s) {"+ _N);
		bw.write("		try {"+ _N);
		...
		bw.write("	}"+ _N);
		bw.write(_N);
		bw.write("	private static final close(final Connection con) {"+ _N);
		bw.write("		try {"+ _N);
